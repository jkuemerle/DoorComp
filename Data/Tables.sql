CREATE TABLE Doors (ID bigint NOT NULL IDENTITY(1,1), DoorID nvarchar(20) NOT NULL, Location nvarchar(200), Description nvarchar(200) NULL, EventID bigint NULL)
GO
